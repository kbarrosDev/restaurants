...
export default function RegisterForm() {
    ...
    const validateData = () =>{
        ...
        if(size(formData.confirm)< 6){
            setErrorConfirm("Debes ingresar una confirmación contraseña de al menos 6 caracteres")
            isValid = false
        }
        ...
        <View style={styles.form}>
            ...
            <Input
                ...
                rightIcon={
                    <Icon
                        type="material-community"
                        name={ confirmShowPassword ? "eye-outline" : "eye-off-outline" }
                        iconStyle={styles.icon}
            ...
            />
            <Loading isVisible={setLoading} text="Creando cuenta..." />
        </View>
